            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                ...
                <div>
                    ...
                    " onfocus="this.style.borderColor='#667eea'" onblur="this.style.borderColor='#e0e0e0'">
                        ...
                        <option value="/category-jackets.html">Куртки (Jackets)</option>
                        <option value="/category-coats.html">Пальто (Coats)</option>
                        <option value="/category-shoes.html">Обувь (Shoes)</option>
                        <option value="/category-sweaters.html">Свитеры (Sweaters)</option>
                        <option value="/category-pants.html">Брюки (Pants)</option>
                        <option value="/category-glasses.html">Очки (Glasses)</option>
                        <option value="/category-hats.html">Головные уборы (Hats)</option>
                        <option value="/shop-all.html">Все товары (Shop All)</option>
                        <option value="/product.html">Страница товара (Product)</option>
                        <option value="#">Без ссылки (No Link)</option>
                    </select>
        ...
        fetch('/api/campaign-content')
            ...
            .then(data => {
                if (data[campaignId] && data[campaignId].buttonLink) {
                    document.getElementById('edit-button-link').value = data[campaignId].buttonLink;
                }
            })
